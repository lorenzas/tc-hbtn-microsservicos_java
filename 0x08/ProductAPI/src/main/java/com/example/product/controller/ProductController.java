...
public class ProductController {
    ...
    public ResponseEntity<Product> findById(@PathVariable("id") Long id) {
        Optional<Product> product = Optional.ofNullable(productRepository.getProductById(Math.toIntExact(id)));
    ...
    public ResponseEntity<Product> insert(@RequestBody Product product) {
        try {
            ...
            return new ResponseEntity<>(productRepository.getProductById(Math.toIntExact(product.getId())), HttpStatus.OK);
        } catch (Exception e) {
    ...
    public ResponseEntity<Product> update(@RequestBody Product product) {
        Optional<Product> productById = Optional.ofNullable(productRepository.getProductById(Math.toIntExact(product.getId())));
